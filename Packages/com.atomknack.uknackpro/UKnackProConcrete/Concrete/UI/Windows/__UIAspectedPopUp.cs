...
{
    public class __UIAspectedPopUp : __UIAspectedModalAbstract
    {
        [SerializeField] private UnityEvent<GameObject> _afterOpen;
        [SerializeField] private UnityEvent<GameObject> _beforeClosed;
        ...
        protected override GameObject LastOpenedWindow => 
            throw new NotImplementedException();

        protected override GameObject CreateNewModal()
        {
            throw new NotImplementedException();
        }

        protected override void InitWindow(GameObject window)
        {
        ...
        protected override void AfterOpened(GameObject window) =>
            _afterOpen?.Invoke(window);

        protected override void BeforeClosed(GameObject window) =>
        ...
        protected override GameObject ModalWindowCreation()
        {
